...
FRONTEND_URL = os.environ.get("FRONTEND_URL") or os.environ.get("RENDER_EXTERNAL_URL") or "http://localhost:5173"
GITHUB_CALLBACK_URL = os.environ.get("GITHUB_CALLBACK_URL") or f"{os.environ.get('RENDER_EXTERNAL_URL', 'http://localhost:5000').rstrip('/')}/auth/github/callback"
